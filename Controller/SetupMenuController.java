...
/**
 * Created by Arianne on 2016-11-25.
 */
...
public class SetupMenuController {
    ...
    private String datjson = dummyJSON();
    ...
    public int makeGangByColour(String[] bots, int colour, boolean isAI) {
        ...
        Object[] robotsByName = gson.fromJson(datjson, new TypeToken<Object[]>() {}.getType());

        Robot[] robots = new Robot[3];

        // Loop over all robots in JSON
        for (int i = 0; i < robotsByName.length; i++) {
            // Put current robot info in LinkedTreeMap
            LinkedTreeMap<String, Object> curr = (LinkedTreeMap<String, Object>) robotsByName[i];
     ...
     * @throws throw Exeption if the number of gangs is off
     */
